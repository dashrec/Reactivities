...
export default observer(function ProfilePhotos({ profile }: Props) {
  ...
  function handleSetMain(photo: Photo, e: SyntheticEvent<HTMLButtonElement>) {
   setTarget(e.currentTarget.name); // it will prevent spinning loading indicator on a false button
    setMainPhoto(photo);
  }
...
// so in order to make the two buttons different we add main as a name and loading = {target === 'main' } to prevent spinning both indicators